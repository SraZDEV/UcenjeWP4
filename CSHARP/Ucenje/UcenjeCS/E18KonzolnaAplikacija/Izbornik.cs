...
namespace UcenjeCS.E18KonzolnaAplikacija
{
    internal class Izbornik
    {
        ...
        public ObradaSmjer ObradaSmjer { get; set; } = new ObradaSmjer(); // da ne moram raditi instancu u konstruktoru
        ...
        private void OdabirOpcijeIzbornika()
        {
            ...
            switch(Pomocno.UcitajRasponBroja("Odaberite stavku izbornika", 1, 4))
            {
                ...
                case 4:
                    Console.WriteLine("Hvala na korištšenju alikacije, doviđenja!");
                    break;
            }
