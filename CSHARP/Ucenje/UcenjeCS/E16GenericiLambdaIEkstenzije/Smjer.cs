...
{
    internal class Smjer: Entitet, ISucelje, IComparable<Smjer> // jedna klasa može nasljediti jednu klasu, a može implementirati više klasa (sa "I" implementira sučelje)
    {
